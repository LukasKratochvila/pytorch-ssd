...
from .config import vgg_ssd_config640 as config
...
def create_vgg_ssd_predictor(net, candidate_size=200, nms_method=None, iou_threshold=config.iou_threshold, sigma=0.5, device=None):

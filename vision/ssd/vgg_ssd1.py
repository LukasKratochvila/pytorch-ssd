...
from .config import vgg_ssd_config1 as config


def create_vgg_ssd1(num_classes, is_test=False):
...
def create_vgg_ssd_predictor1(net, candidate_size=200, nms_method=None, iou_threshold=config.iou_threshold, sigma=0.5, device=None):
